...
Or for more in-depth analysis, the user can assign to a variable to be called.
...
# To display how many countries are available
dim(result)

# To check specific country is available or not
any(result$name == "Belgium")

# To display country code for specific country
result[result$name == "Belgium", "countryCode"]
```
